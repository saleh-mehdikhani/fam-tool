...
def initialize_project(root_path_str):
    ...
    try:
        ...
        # Add README to graph_source_repo
        readme_content_graph = "This project is generated by fam tool (https://github.com/saleh-mehdikhani/fam-tool) and should be edited mainly by this tool not manually."
        (graph_source_path / 'README.md').write_text(readme_content_graph)
        ...
        # Add README to data_repo
        readme_content_data = "This project is generated by fam tool (https://github.com/saleh-mehdikhani/fam-tool) and should be edited mainly by this tool not manually.\nFor the data repo, people yaml files can be edited manually except the id part."
        (root_path / 'README.md').write_text(readme_content_data)
